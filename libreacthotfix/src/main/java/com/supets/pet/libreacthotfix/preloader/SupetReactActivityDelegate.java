...
public class SupetReactActivityDelegate {
    ...
    public SupetReactActivityDelegate(Activity activity, @Nullable String mainComponentName) {
        mActivity = activity;
        mMainComponentName = mainComponentName;
        mFragmentActivity = null;
    }

    public SupetReactActivityDelegate(
    ...
    protected ReactRootView createRootView(String appKey) {
        ReactRootView rootView = ReactPreLoader.getRootView(mMainComponentName);
        if (rootView == null) {
